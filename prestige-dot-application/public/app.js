...
form.addEventListener('submit',async e=>{e.preventDefault();if(!validate())return;
  ...
  catch(error){problem(error.message||'Unable to submit. Your form remains here; please try again.');submit.disabled=false}
});
